        ...
        <div className="bg-white/10 backdrop-blur-sm border border-amber-800/30 rounded-2xl p-8 shadow-xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="mb-6">
                <h2 className="text-2xl mt-2 font-bold text-amber-100 mb-3">
                  Tech Stack
                </h2>
                <div className="flex flex-wrap gap-2">
                  {project.tags.map((tag, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 bg-amber-900/30 text-amber-200 rounded-full"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-amber-100/80">{project.challenges}</p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-amber-200 mb-2">
                    Learnings
                  </h3>
                  <p className="text-amber-100/80">{project.learnings}</p>
                </div>
              </div>
            </div>
          </div>
